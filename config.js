...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '916282524515-1632403322@g.us',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || '').trim() || 'Raganork~7bd41860211b094b4fdb25fffa5e7ad0:71636b744a7249332f39553d',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || ' ᴀɴsʜɪғ xᴇʀ;rozario11;0;https://i.imgur.com/a6qfrvI.mp4;https://chat.whatsapp.com/GYwATz9YnKy0c9WygfoY4E',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "ᴀɴsʜɪғ xᴇʀ",
    BOT_NAME: process.env.BOT_NAME || ' ᴀɴsʜɪғ xᴇʀ',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭rozario xer¹¹ꫂ; ᴀɴsʜɪғ xᴇʀ MD bot;https://i.imgur.com/a6qfrvI.mp4' : process.env.AUDIO_DATA,
